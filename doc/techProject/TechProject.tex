...
\begin{thebibliography}{97}
	...
	\bibitem[{Similar Web(2023)}]{similarweb_mixesdbcom_2023}
	Similar Web (2023): \enquote{mixesdb.com {Traffic} {Analytics} \& {Market} {Share}},
	\urlprefix\url{https://www.similarweb.com/website/mixesdb.com/} (Accessed: 20th March 2023).
	...
	\bibitem[{Zhang et~al.(2019)Zhang, Fuguo, Qi}]{zhang2020alleviating}
	Zhang, F., Qi, S., Liu, Q., Mao, M. and Zeng, A. (2020): "Alleviating the data sparsity problem of recommender systems by clustering nodes in bipartite networks", \textit{Expert Systems with Applications}, 149, p.113346.
